...
echo "<td>" .CHtml::link('Mostrar Material',array('salidaMat/admin/'.$item->id),array('class'=>'btn btn-success btn-sm')) . "</td>";
echo "<td>" .CHtml::link('Mostrar Insumos',array('salidasReactivos/admin/'.$item->id),array('class'=>'btn btn-info btn-sm')) . "</td>";
