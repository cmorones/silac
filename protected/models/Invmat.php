...
/**
 * This is the model class for table "inv_materiales".
 *
 * The followings are the available columns in table 'inv_materiales':
 * @property integer $id
 ...
 */
class Invmat extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Invmat the static model class
	 */
