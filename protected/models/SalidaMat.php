...
/**
 * This is the model class for table "salidas_materiales".
 *
 * The followings are the available columns in table 'salidas_materiales':
 * @property integer $id
 ...
 */
class SalidaMat extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SalidaMat the static model class
	 */
